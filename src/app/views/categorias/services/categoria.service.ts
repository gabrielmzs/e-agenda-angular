...
export class CategoriaService {
    ...
    ): Observable<ListarCategoriaViewModel> {
        return this.http
    ...
    public editar(id: string, categoria: ListarCategoriaViewModel) {
        return this.http
    ...
    public selecionarPorId(id: string): Observable<ListarCategoriaViewModel> {
        return this.http
